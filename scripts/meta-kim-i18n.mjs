...
const STRINGS = {
  en: {
    ...
    val: {
      ...
      step08: "Checking documentation fact references",
      step08Detail: "documentation references must align with repo facts",
      step08Pass: "Documentation references are aligned with repo facts",
      step09: "Checking package.json scripts",
      step09Detail:
        "meta:sync / meta:validate / meta:eval:agents / meta:verify:all, etc.",
      step09Pass: "All required scripts registered",
      step10: "Checking .gitignore rules",
      step10Detail: "node_modules/ / docs/ / local state isolation, etc.",
      step10Pass: ".gitignore contains all necessary local-state rules",
      step11: "Checking canonical MCP config",
      step11Detail: "meta-kim-runtime service definition and startup command",
      step11Pass: "Canonical MCP config is valid",
  ...
  "zh-CN": {
    ...
    val: {
      ...
      step08: "检查文档事实引用",
      step08Detail: "文档引用必须与仓库事实一致",
      step08Pass: "文档引用与仓库事实一致",
      step09: "检查 package.json scripts",
      step09Detail:
        "meta:sync / meta:validate / meta:eval:agents / meta:verify:all, etc.",
      step09Pass: "所有必需脚本已注册",
      step10: "检查 .gitignore 规则",
      step10Detail: "node_modules/ / docs/ / local state isolation, etc.",
      step10Pass: ".gitignore 包含所有必需的 local-state 规则",
      step11: "检查 canonical MCP 配置",
      step11Detail: "meta-kim-runtime 服务定义和启动命令",
      step11Pass: "Canonical MCP 配置有效",
  ...
  "ja-JP": {
    ...
    val: {
      ...
      step08: "ドキュメント事実参照のチェック",
      step08Detail: "ドキュメント参照はリポジトリ事実と一致する必要があります",
      step08Pass: "ドキュメント参照はリポジトリ事実と一致しています",
      step09: "package.json scripts のチェック",
      step09Detail:
        "meta:sync / meta:validate / meta:eval:agents / meta:verify:all, etc.",
      step09Pass: "すべての必須スクリプトが登録済みです",
      step10: ".gitignore ルールのチェック",
      step10Detail: "node_modules/ / docs/ / local state isolation, etc.",
      step10Pass:
        ".gitignore にはすべての必要な local-state ルールが含まれています",
      step11: "canonical MCP 設定のチェック",
      step11Detail: "meta-kim-runtime サービス定義と起動コマンド",
      step11Pass: "Canonical MCP 設定が有効です",
  ...
  "ko-KR": {
    ...
    val: {
      ...
      step08: "문서 사실 참조 확인",
      step08Detail: "문서 참조는 저장소 사실과 일치해야 합니다",
      step08Pass: "문서 참조가 저장소 사실과 일치합니다",
      step09: "package.json scripts 확인",
      step09Detail:
        "meta:sync / meta:validate / meta:eval:agents / meta:verify:all, etc.",
      step09Pass: "모든 필수 스크립트가 등록되어 있습니다",
      step10: ".gitignore 규칙 확인",
      step10Detail: "node_modules/ / docs/ / local state isolation, etc.",
      step10Pass:
        ".gitignore에 모든 필요한 local-state 규칙이 포함되어 있습니다",
      step11: "canonical MCP config 확인",
      step11Detail: "meta-kim-runtime 서비스 정의와 시작 명령",
      step11Pass: "Canonical MCP config가 유효합니다",
